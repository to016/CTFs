...
public final class modifiedByteArrayGuard {
    ...
    private void setupKeyAndMac() {
        try {
            ...
            byte[] keyArray = Base64.getDecoder().decode("ZmluZF90aGVfa2V5X3Bscw==".getBytes("UTF-8"));
            this.sk = new SecretKeySpec(keyArray, "AES");
        } catch (NamingException | UnsupportedEncodingException var5) {
